import React from 'react'
 ...
 const AboutMe =()=>{
   return(
     <div style={container}>
      <div style={aboutMeHeaderFontStyle}>About Me</div>
      <div style={aboutMeDescriptionFontStyle}>
      ...
      nulla pariatur?" quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum
...
const aboutMeHeaderFontStyle={
  fontSize:20,
  fontWeight:'bold',
}
const aboutMeDescriptionFontStyle={
  lineHeight:2,
  fontSize:14,
  overflowY:'auto',
  height:"35vh"
